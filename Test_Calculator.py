...
Delete = Button(calc,height =2,width=4,padx=10, pady = 10, text = "Del",bg="green")
Delete["command"] = sum1.backspace
Delete.grid(row = 1, column = 4, padx=1, pady = 1)

Off = Button(calc,height =2,width=4,padx=10, pady = 10, text = "OFF",bg="green")
Off["command"] = sum1.qExit
Off.grid(row = 1, column = 5, padx=1, pady = 1)

add = Button(calc,height =2,width=4,padx=10, pady = 10, text = "+",bg="steel blue")
add["command"] = lambda: sum1.operation("add")
add.grid(row = 2, column = 3,  padx=1, pady = 1)

Left_parenthesis = Button(calc,height =2,width=4,padx=10, pady = 10, text = "(",bg="steel blue")
Left_parenthesis["command"] = lambda: self.action('(')
Left_parenthesis.grid(row = 2, column = 4,  padx=1, pady = 1)

Right_parenthesis = Button(calc,height =2,width=4,padx=10, pady = 10, text = ")",bg="steel blue")
Right_parenthesis["command"] = lambda: self.action(')')
Right_parenthesis.grid(row = 2, column = 5,  padx=1, pady = 1)
...
mult.grid(row = 3, column = 4,  padx=1, pady = 1)

cube = Button(calc,height =2,width=4,padx=10, pady = 10, text = "x^3",bg="steel blue")
cube["command"] = lambda: sum1.operation("cube")
cube.grid(row = 3, column = 5,  padx=1, pady = 1)

point = Button(calc,height =2,width=4,padx=10, pady = 10, text = ".",bg="green")
...
neg= Button(calc,height =2,width=4,padx=10, pady = 10, text = "+/-",bg="green")
...
loge.grid(row=4, column=5, padx=1, pady=1)


power = Button(calc, height=2,width=4,padx=10,pady=10,text="x^2",bg="green")
...
pi = Button(calc, height=2, width=4, padx=10, pady=10, text="Pi", bg="green")
pi["command"] = lambda: sum1.operation("inv")
pi.grid(row=5,column=3,padx=1,pady=1)

Exponent = Button(calc, height=2, width=4, padx=10, pady=10, text="Exp", bg="green")
...
Off["command"] = sum1.qExit
Off.grid(row = 1, column = 5, padx=1, pady = 1)
rootof = Button(calc, height=2, width=4, padx=10, pady=10, text="\/x", bg = "green")
...
Cubeof = Button(calc, height=2, width=4, padx=10, pady=10, text='\/3', bg="green")
...
equals.grid(row = 5, column = 5,columnspan=1,rowspan=2,padx=1, pady = 1)
